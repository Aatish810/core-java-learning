...
//                System.out.println("Writing location exits " + (location.getExits().size() - 1) + " exits");
...
//            String descreption = locFile.readUTF();
...
//            }
//            locations.put(locId, new Location(locId, descreption, exits));
        ...
        try(ObjectInputStream locFile = new ObjectInputStream(new BufferedInputStream(new FileInputStream("location.dat")))) {
            ...
            while (!eof) {
                try {
                    ...
                    System.out.println("Total exists " + location.getExits().size());
                } catch(EOFException e) {
                    eof = true;
                }
            }
...
// Entire code is for java before JAVA 7 without try with resources
...
//        }
        ...
        // Now read the exits without try with resources
//        try {
...
//        locations.put(5, new Location(5, "You are in the forest",tempExit));
        ...
        // Below code is with Try with resources and supported from JDK7
